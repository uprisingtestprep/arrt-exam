/* ARRT Exam Simulator, Application Logic */

const ACCESS_CODE  = "ARRT9000";
const EXAM_SECONDS = 13799;
const PASSING_PCT  = 75;
const STORAGE_KEY  = "arrt_exam_state_v1";
...
const DOMAIN_LABELS = {"patient_care": "Patient Care", "safety": "Safety", "image_production": "Image Production", "procedures": "Procedures"};  // maps domain key -> human-readable label for display
